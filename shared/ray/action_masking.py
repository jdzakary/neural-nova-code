"""
This file is a near-copy of the RlLib official example found here:
https://github.com/ray-project/ray/blob/master/rllib/examples/rl_modules/classes/action_masking_rlm.py

When attempting to use this example with RlLib's new API, training crashed.
I made a few modifications to ensure it works properly.
Aside from this, all credit goes to the original authors.
"""
...
class ActionMaskingRLModule(RLModule, ABC):
